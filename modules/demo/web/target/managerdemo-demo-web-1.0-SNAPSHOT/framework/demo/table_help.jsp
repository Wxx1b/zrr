...
<body>
<!-- 主要内容 -->
<div class="ui-state-highlight" style="padding:0.5em"><b>&nbsp;表格控件:帮助信息 - ui:table/ui:col</b></div>
<layout:tabs>
<layout:tab title="范例">

<ui:table id="testTable" actionClass="com.sinitek.spirit.webcontrol.demo.DemoTableAction" pageSize="10">
    <ui:col property="DemoString" title="字符串" helpContent="helpDiv"/>
...
<div class="help_tips" style="display: none;" id="helpDiv"><img src="../css/blue/images/gongshi.png"></div>
