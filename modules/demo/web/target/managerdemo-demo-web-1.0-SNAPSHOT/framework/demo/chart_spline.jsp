...
<body>
<!-- 主要内容 -->
<div class="ui-state-highlight" style="padding:0.5em"><b>&nbsp;线状图表 - 圆滑</b></div>
<layout:tabs>
<layout:tab title="范例">
    <chart:define id="line" name="line" type="spline" dataVar="result" clazz="com.sinitek.spirit.webcontrol.demo.DemoChart" width="100%" height="400px">
        <chart:title text="每月平均气温"/>

        <chart:subtitle text="线状图表 - 圆滑范例"/>
...
<%out.print( HtmlUtils.htmlEscape("    <chart:define id=\"line\" name=\"line\" type=\"spline\" dataVar=\"result\" clazz=\"com.sinitek.spirit.webcontrol.demo.DemoChart\" width=\"100%\" height=\"400px\">\n" +
        "        <chart:title text=\"每月平均气温\"/>\n" +
        "\n" +
        "        <chart:subtitle text=\"线状图表 - 圆滑范例\"/>\n" +
        "\n" +
