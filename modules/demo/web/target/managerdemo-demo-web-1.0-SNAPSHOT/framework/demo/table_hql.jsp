...
<body>
<!-- 主要内容 -->
<div class="ui-state-highlight" style="padding:0.5em"><b>&nbsp;表格控件:Hql - ui:table/ui:col</b></div>
<layout:tabs>
<layout:tab title="范例">
...
<ui:table id="testTable" actionClass="com.sinitek.spirit.webcontrol.demo.DemoTableHqlAction" pageSize="3">
