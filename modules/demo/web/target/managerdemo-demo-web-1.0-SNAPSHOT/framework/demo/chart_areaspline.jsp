...
<body>
<!-- 主要内容 -->
<div class="ui-state-highlight" style="padding:0.5em"><b>&nbsp;面积图表 - 圆滑</b></div>
<layout:tabs>
<layout:tab title="范例">
    <chart:define id="area" name="area" type="areaspline" dataVar="result" clazz="com.sinitek.spirit.webcontrol.demo.DemoChart" width="100%" height="400px">
        <chart:title text="美国和俄罗斯核武器存储量"/>

        <chart:subtitle text="面积图表 - 圆滑范例"/>
        ...
        <chart:plotOptions>
            <chart:plotOption type="areaspline" pointStart="1940">
                <chart:marker enabled="false" symbol="circle" radius="3">
                    states: {
                        hover: {
                            enabled: true
                        }
...
<%out.print( HtmlUtils.htmlEscape("    <chart:define id=\"area\" name=\"area\" type=\"areaspline\" dataVar=\"result\" clazz=\"com.sinitek.spirit.webcontrol.demo.DemoChart\" width=\"100%\" height=\"400px\">\n" +
        "        <chart:title text=\"美国和俄罗斯核武器存储量\"/>\n" +
        "\n" +
        "        <chart:subtitle text=\"面积图表 - 圆滑范例\"/>\n" +
        "\n" +
