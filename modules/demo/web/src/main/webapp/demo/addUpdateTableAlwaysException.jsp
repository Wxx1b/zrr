    ...
    <script type="text/javascript">
        ...
        function submitForm() {
            if ($("#addUpdateForm").stk_checkForm()) {
                $("#addUpdateForm").stk_submit(function (returnstr) {
                    if(returnstr)   //  success or err message
                    {
                        alert(returnstr);   //  info
                    }
                    else
                    {
...
<layout:window width="600px" layout="column" id="addUpdateWindow" title="添加/修改">
    <ui:form clazz="com.sinitek.managerdemo.demo.action.DemoAddUpdateTableAction"
             method="addUpdateServiceAlwaysException" id="addUpdateForm">
