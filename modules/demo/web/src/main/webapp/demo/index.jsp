...
<%--
                <li><label>枚举</label>
                    ...
                    <ui:select list="#attr.DemoEnumList" name="DemoEnum" headerKey="" headerValue="--请选择--"
                              listKey="enumItemName" listValue="enumItemInfo" title="测试title" mixture="true"></ui:select>
                </li>
--%>
        ...
        <table class="stk-form-ui-st1">
            ...
            <tr>
                ...
                <td class="bd" width="auto">
                    <ui:select list="#attr.DemoEnumList" id="DemoEnum" name="DemoEnum" headerKey="" headerValue="--请选择--" listKey="enumItemName" listValue="enumItemInfo" mixture="true"></ui:select>
                </td>
            </tr>
            --%>
            <tr>
            ...
            <tr>
                <td class="hd" width="80">实体</td>
                <td class="bd" width="auto">
                        <ui:doceditor imageUploadJson="/imageUpload" id="de11" name="sad" defaultValue="112131"/>
                </td>
            </tr>
            <tr class="btn-bar">
                <td class="hd"></td>
