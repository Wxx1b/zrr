...
<body>
<!-- 主要内容 -->
<div class="ui-state-highlight" style="padding:0.5em"><b>&nbsp;横木图表 - 堆栈</b></div>
<layout:tabs>
<layout:tab title="范例">
    <chart:define id="bar" name="bar" type="bar" dataVar="result" clazz="com.sinitek.spirit.webcontrol.demo.DemoChart" width="100%" height="400px">
        ...
        <chart:plotOptions>
            <chart:plotOption type="series" stacking="normal"/>
        </chart:plotOptions>
...
<%out.print( HtmlUtils.htmlEscape("    <chart:define id=\"bar\" name=\"bar\" type=\"bar\" dataVar=\"result\" clazz=\"com.sinitek.spirit.webcontrol.demo.DemoChart\" width=\"100%\" height=\"400px\">\n" +
        "        <chart:title text=\"世界人口图\"/>\n" +
        "\n" +
        "        <chart:subtitle text=\"横木图表 - 堆栈范例\"/>\n" +
        "\n" +
