...
<body>
<div class="ui-state-highlight" style="padding:0.5em"><b>&nbsp;菜单按钮 - ui:buttonMenu</b></div>

<!-- 主要内容 -->
<layout:tabs>
<layout:tab title="范例">

<ui:buttonMenu targetMenu="menuId" icon="ui-icon-gear" text="分开事件" clickToShow="fasle">
    <event:onclick>
        alert("ok");
    </event:onclick>
</ui:buttonMenu>

<ui:buttonMenu targetMenu="menuId" icon="ui-icon-gear" text="统一展开"/>

<ui:buttonMenu targetMenu="menuId" icon="ui-icon-gear" text="无背景" feature="noBg"/>
...
<%out.print( HtmlUtils.htmlEscape("<ui:buttonMenu targetMenu=\"menuId\" icon=\"ui-icon-gear\" text=\"分开事件\" clickToShow=\"fasle\">\n" +
        "    <event:onclick>\n" +
        "        alert(\"ok\");\n" +
        "    </event:onclick>\n" +
        "</ui:buttonMenu>\n" +
