...
<body>
<!-- 主要内容 -->
<div class="ui-state-highlight" style="padding:0.5em"><b>&nbsp;面积图表</b></div>
<layout:tabs>
<layout:tab title="范例">
    <chart:define id="area" name="area" type="area" dataVar="result" clazz="com.sinitek.spirit.webcontrol.demo.DemoChart" width="100%" height="400px">
