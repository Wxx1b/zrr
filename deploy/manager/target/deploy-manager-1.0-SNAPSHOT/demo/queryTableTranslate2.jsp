...
<body>
<ui:table id="queryTable" actionClass="com.sinitek.managerdemo.demo.action.DemoQueryTableTranslateAction2">
    <ui:col property="name" title="姓名"></ui:col>
    <%--<ui:colCust method="getAxis" title="转换之后的姓名"></ui:colCust>--%>
