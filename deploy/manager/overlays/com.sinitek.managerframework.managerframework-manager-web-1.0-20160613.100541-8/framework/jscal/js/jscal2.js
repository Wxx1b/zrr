...
Calendar = function() {
    ...
    a.SEL_NONE = 0,a.SEL_SINGLE = 1,a.SEL_MULTIPLE = 2,a.SEL_WEEK = 3,a.dateToInt = O,a.intToDate = P,a.printDate = R,a.formatString = K,a.i18n = L,a.LANG = function(a, b, c) {
        ...
        h.position = "absolute",h.left = a + "px",h.top = b + "px",h.zIndex = 99999,h.display = "",c && (f.style.marginTop = -g + "px",this.args.opacity > 1 && bf(d, 0),this._showAnim = bd({onUpdate:function(a, b) {
        ...
        if(inputId){
            if(typeof(window[inputId+"_afterHidePopup"])=='function') window[inputId+"_afterHidePopup"]();
        }
    },h.popup = function(a, b) {
        if(typeof(window[this.inputField.id+"_beforePopup"])=='function') window[this.inputField.id+"_beforePopup"]();
        function h(b) {
            var c = {x:i.x,y:i.y};
            if (!b)return c;
